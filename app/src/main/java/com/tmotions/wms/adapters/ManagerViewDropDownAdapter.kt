...
class ManagerViewDropDownAdapter(context: Context, myRequestArr: ArrayList<LeaveTypesList>) : BaseAdapter() {

    private val layoutInflater: LayoutInflater
    private val myRequestArr: ArrayList<LeaveTypesList>
    init {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        vh.txtItemName.text = dropDownList.Text
        return view
